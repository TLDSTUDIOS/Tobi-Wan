...
public class CanceljutsuProcedure extends ShinobicraftModElements.ModElement {
	public CanceljutsuProcedure(ShinobicraftModElements instance) {
		super(instance, 369);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Canceljutsu!");
			return;
		}
