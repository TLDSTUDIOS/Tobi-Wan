...
public class Cb9showProcedure extends ShinobicraftModElements.ModElement {
	public Cb9showProcedure(ShinobicraftModElements instance) {
		super(instance, 220);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Cb9show!");
			return false;
		}
		...
		return (((entity.getCapability(ShinobicraftModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new ShinobicraftModVariables.PlayerVariables())).currentchakra) >= (((entity
						...
						.orElse(new ShinobicraftModVariables.PlayerVariables())).maxchakra) * 0.4));
	}
}
