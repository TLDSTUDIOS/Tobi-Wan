...
public class Cb8showProcedure extends ShinobicraftModElements.ModElement {
	public Cb8showProcedure(ShinobicraftModElements instance) {
		super(instance, 219);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Cb8show!");
			return false;
		}
		...
		return (((entity.getCapability(ShinobicraftModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new ShinobicraftModVariables.PlayerVariables())).currentchakra) >= (((entity
						...
						.orElse(new ShinobicraftModVariables.PlayerVariables())).maxchakra) * 0.35));
	}
}
