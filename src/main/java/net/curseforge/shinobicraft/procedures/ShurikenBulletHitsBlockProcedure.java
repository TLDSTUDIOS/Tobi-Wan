...
public class ShurikenBulletHitsBlockProcedure extends ShinobicraftModElements.ModElement {
	public ShurikenBulletHitsBlockProcedure(ShinobicraftModElements instance) {
		super(instance, 130);
	}
