...
public class Cb13showProcedure extends ShinobicraftModElements.ModElement {
	public Cb13showProcedure(ShinobicraftModElements instance) {
		super(instance, 224);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Cb13show!");
			return false;
		}
		...
		return (((entity.getCapability(ShinobicraftModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new ShinobicraftModVariables.PlayerVariables())).currentchakra) >= (((entity
						...
						.orElse(new ShinobicraftModVariables.PlayerVariables())).maxchakra) * 0.6));
	}
}
