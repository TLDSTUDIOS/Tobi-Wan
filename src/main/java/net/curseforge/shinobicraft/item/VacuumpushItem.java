...
import net.curseforge.shinobicraft.procedures.VacuumpushWhileBulletFlyingTickProcedure;
...
public class VacuumpushItem extends ShinobicraftModElements.ModElement {
	@ObjectHolder("shinobicraft:vacuumpush")
	public static final Item block = null;
	@ObjectHolder("shinobicraft:entitybulletvacuumpush")
	public static final EntityType arrow = null;
	public VacuumpushItem(ShinobicraftModElements instance) {
		super(instance, 357);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletvacuumpush").setRegistryName("entitybulletvacuumpush"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void tick() {
			...
			Entity entity = this.getShooter();
			{
				...
				VacuumpushWhileBulletFlyingTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				this.remove();
			}
