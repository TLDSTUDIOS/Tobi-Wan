...
public class KunaiItem extends ShinobicraftModElements.ModElement {
	@ObjectHolder("shinobicraft:kunai")
	public static final Item block = null;
	@ObjectHolder("shinobicraft:entitybulletkunai")
	public static final EntityType arrow = null;
	public KunaiItem(ShinobicraftModElements instance) {
		super(instance, 301);
	}
