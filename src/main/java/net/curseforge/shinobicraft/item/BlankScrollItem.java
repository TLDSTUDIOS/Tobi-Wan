...
import net.curseforge.shinobicraft.gui.BlankscrollguiGui;
...
public class BlankScrollItem extends ShinobicraftModElements.ModElement {
	@ObjectHolder("shinobicraft:blank_scroll")
	public static final Item block = null;
	public BlankScrollItem(ShinobicraftModElements instance) {
		super(instance, 88);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BlankscrollguiGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A blank scroll."));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Scroll");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BlankscrollguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
